...
from constants import FS, N_SAMPLES_TRAIN, N_SAMPLES_TEST
from utils import magnitude_spectrum, individual_max_snr_band, delay_align
...
# load data
eeg_df = pd.read_pickle('data/train_test_data_multichannel.pkl')
# eeg_df  = eeg_df.query('subj_id==4')
datasets = eeg_df.subj_id.unique()
